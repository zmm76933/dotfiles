...
DOTFILES_GITHUB="https://github.com/zmm76933/dotfiles.git"; export DOTFILES_GITHUB
...
dotfiles_logo='
  ...
  *** WHAT IS INSIDE? ***
  1. Download https://github.com/zmm76933/dotfiles.git
  2. Symlinking dot files to your home directory
  3. Execute all sh files within `etc/init/` (optional)

  See the README for documentation.
  https://github.com/zmm76933/dotfiles

  Copyright (c) 2014 "BABAROT" aka @zmm76933
...
dotfiles_download() {
    ...
    if is_debug; then
        ...
        if is_exists "git"; then
            ...
            # curl or wget
            local tarball="https://github.com/zmm76933/dotfiles/archive/master.tar.gz"
